...
$m_fontBox = imagettfbbox($maker['font_size1'], 0, $maker['font1'], $maker['str2']);
$m_x = ($m_width - $m_fontBox[2]) / 2;  // 获取字符宽度并居中显示
imagettftext($m_im, $maker['font_size1'], 0, $m_x, 460, $m_color, $maker['font1'], $maker['str2']);  // 在图片上绘制文字

$m_fontBox = imagettfbbox($maker['font_size1'], 0, $maker['font1'], $maker['str3']);
$m_x = ($m_width - $m_fontBox[2]) / 2;  // 获取字符宽度并居中显示
imagettftext($m_im, $maker['font_size1'], 0, $m_x, 678, $m_color, $maker['font1'], $maker['str3']);  // 在图片上绘制文字
