...
$endpic="../temp/".date("YmdHis")."-".rand(1000,9999).".jpg";//结果图
//字体
function wordfont_select($wordfont_p){
//此处配置字体，字体名称和字体文件需一一对应，字体路劲更改在下方$font参数
//字体名称，显示在选择框内
$str_font="新宋|楷体|黑体|幼圆|方正小篆体";
//字体文件，带后缀是因为字体后缀不同
$str_font2="simsun.ttc|simkai.ttf|simhei.ttf|yy.ttf|fzxz.ttf";
...
if ($yes){
	...
	echo "<hr>文字总数".mb_strlen($content,"UTF-8")."  总行数:".$pagen." 换行数:".$pagebr."  总高(行x行间距)".$pageh."<hr>";
		//检查是否支持GD
